                                    ...
                                    <form wire:submit.prevent="saveDokumen('{{ $input_model_dokumen }}')">
                                        <div class="row">
                                            <div class="col-12 col-md-4 mb-2">
                                                ...
                                                <input list="jenis_dokumens" id="jenis_dokumen" class="form-control" wire:model="jenis_dokumen" placeholder="Pilih atau ketik...">
                                                <datalist id="jenis_dokumens">
                                            ...
                                            <div class="col-12 col-md-8 mb-2">
                                                <div class="mb-1">
                                                    <span class="text-muted">Size Maksimal: 50 MB (50000 KB)
