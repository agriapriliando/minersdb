                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered align-middle">
                                <thead class="table-light">
                                    <tr>
                                        <th style="width: 5%">#</th>
                                        <th class="text-nowrap">Tahun Laporan</th>
                                        <th class="text-nowrap">Laporan Triwulan I</th>
                                        <th class="text-nowrap">Laporan Triwulan II</th>
                                        <th class="text-nowrap">Laporan Triwulan III</th>
                                        <th class="text-nowrap">Laporan Triwulan IV</th>
                                        <th class="text-nowrap" style="width: 20%">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($triwulan as $id => $item)
                                        <tr wire:key="triwulan-row-{{ $id }}" x-data="{ confirmDelete: false }">
                                            <td>{{ $loop->iteration }}</td>

                                            {{-- Tahun Laporan --}}
                                            <td>
                                                <input type="text" class="form-control form-control-sm @error('triwulan.' . $id . '.triwulan_tahun') is-invalid @enderror"
                                                    wire:model="triwulan.{{ $id }}.triwulan_tahun" :disabled="$wire.editingId !== {{ $id }}">
                                                @error('triwulan.' . $id . '.triwulan_tahun')
                                            ...
                                            {{-- Triwulan I --}}
                                            <td>
                                                <input type="text" class="form-control form-control-sm @error('triwulan.' . $id . '.laporan_triwulan_i') is-invalid @enderror"
                                                    wire:model="triwulan.{{ $id }}.laporan_triwulan_i" :disabled="$wire.editingId !== {{ $id }}">
                                                @error('triwulan.' . $id . '.laporan_triwulan_i')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            ...
                                            {{-- Triwulan II --}}
                                            <td>
                                                <input type="text" class="form-control form-control-sm @error('triwulan.' . $id . '.laporan_triwulan_ii') is-invalid @enderror"
                                                    wire:model="triwulan.{{ $id }}.laporan_triwulan_ii" :disabled="$wire.editingId !== {{ $id }}">
                                                @error('triwulan.' . $id . '.laporan_triwulan_ii')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            ...
                                            {{-- Triwulan III --}}
                                            <td>
                                                <input type="text" class="form-control form-control-sm @error('triwulan.' . $id . '.laporan_triwulan_iii') is-invalid @enderror"
                                                    wire:model="triwulan.{{ $id }}.laporan_triwulan_iii" :disabled="$wire.editingId !== {{ $id }}">
                                                @error('triwulan.' . $id . '.laporan_triwulan_iii')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            ...
                                            {{-- Triwulan IV --}}
                                            <td>
                                                <input type="text" class="form-control form-control-sm @error('triwulan.' . $id . '.laporan_triwulan_iv') is-invalid @enderror"
                                                    wire:model="triwulan.{{ $id }}.laporan_triwulan_iv" :disabled="$wire.editingId !== {{ $id }}">
                                                @error('triwulan.' . $id . '.laporan_triwulan_iv')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </td>
                                    ...
                                    <tr>
                                        <td>+</td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm @error('triwulan_tahun') is-invalid @enderror" wire:model="triwulan_tahun"
                                                placeholder="Tahun Laporan">
                                            @error('triwulan_tahun')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm @error('laporan_triwulan_i') is-invalid @enderror" wire:model="laporan_triwulan_i"
                                                placeholder="Triwulan I">
                                            @error('laporan_triwulan_i')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm @error('laporan_triwulan_ii') is-invalid @enderror" wire:model="laporan_triwulan_ii"
                                                placeholder="Triwulan II">
                                            @error('laporan_triwulan_ii')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm @error('laporan_triwulan_iii') is-invalid @enderror" wire:model="laporan_triwulan_iii"
                                                placeholder="Triwulan III">
                                            @error('laporan_triwulan_iii')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm @error('laporan_triwulan_iv') is-invalid @enderror" wire:model="laporan_triwulan_iv"
                                                placeholder="Triwulan IV">
                                            @error('laporan_triwulan_iv')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>
                                        <td>
